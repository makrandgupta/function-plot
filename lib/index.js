...
module.exports = function (options) {
  ...
  Chart.prototype.initializeAxes = function () {
    ...
    this.meta.xAxis = d3.svg.axis()
      ...
      .innerTickSize(options.xTicks ? options.xTicks.innerSize : 0)
      .outerTickSize(options.xTicks ? options.xTicks.outerSize : 0)
      .ticks(options.xTicks ? options.xTicks.count : 0)
      .tickValues(options.xTicks ? options.xTicks.values : 0)
      .orient('bottom')
    this.meta.yAxis = d3.svg.axis()
      .scale(yScale)
      .tickSize(options.grid ? -width : 0)
      .innerTickSize(options.yTicks ? options.yTicks.innerSize : 0)
      .outerTickSize(options.yTicks ? options.yTicks.outerSize : 0)
      .ticks(options.yTicks ? options.yTicks.count : 0)
      .tickValues(options.yTicks ? options.yTicks.values : 0)
      .orient('left')
  }
