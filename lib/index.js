...
module.exports = function (options) {
  ...
  Chart.prototype.initializeAxes = function () {
    ...
    this.meta.xAxis = d3.svg.axis()
      ...
      .innerTickSize(options.xInnerTickSize ? options.xInnerTickSize : 0)
      .outerTickSize(options.xOuterTickSize ? options.xOuterTickSize : 0)
    ...
    this.meta.yAxis = d3.svg.axis()
      ...
      .innerTickSize(options.yInnerTickSize ? options.yInnerTickSize : 0)
      .outerTickSize(options.yOuterTickSize ? options.yOuterTickSize : 0)
